...
class ElasticDNN_blip_OfflineVQAMDModel(ElasticDNN_OfflineVQAMDModel):
    ...
    def get_distill_loss(self, student_output, teacher_output):
        ...
        #return F.cross_entropy(student_output, teacher_output.detach())
...
if __name__ == '__main__':
    ...
    # 1. init model
    fm_models_dict_path = 'new_impl/mm/Vis_bert/QuestionAnswering/results/blip_lora.py/20231018/999999-095006-/data/zql/concept-drift-in-edge-projects/UniversalElasticNet/new_impl/mm/Vis_bert/QuestionAnswering/blip_lora.py/models/fm_best.pt'
