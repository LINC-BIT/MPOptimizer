...
class ElasticDNN_ClsOnlineModel(ElasticDNN_OnlineModel):
    ...
    def update_fm_param(self, md_param_name, cal_new_fm_param_by_md_param):
        if not ('self_attn.q_proj.weight' in md_param_name or 'self_attn.k_proj.weight' in md_param_name or 'self_attn.v_proj.weight' in md_param_name):
...
elasticfm_model = ElasticDNN_ClsOnlineModel('cls', init_online_model(
    ...
    'new_impl/cv/clip/results/cls_md_index.py/20231114/999997-112438-/data/zql/concept-drift-in-edge-projects/UniversalElasticNet/new_impl/cv/clip/cls_md_index.py/models/fm_best.pt',
    'new_impl/cv/clip/results/cls_md_index.py/20231114/999997-112438-/data/zql/concept-drift-in-edge-projects/UniversalElasticNet/new_impl/cv/clip/cls_md_index.py/models/md_best.pt',
    'cls', __file__
), device, {
    'md_to_fm_alpha': 1,
    'fm_to_md_alpha': 0.01
...
da_alg_hyp = {
    'CityscapesCls': {
        ...
        'optimizer': 'AdamW',
        #'optimizer': 'SGD',
        'optimizer_args': {'lr': 4e-6/2, 'betas': [0.9, 0.999], 'weight_decay': 0.01},#针对于cvt的online的学习率
        #'optimizer_args': {'lr': 1e-3, 'momentum': 0.9},
        'scheduler': '',
        'scheduler_args': {},
        'num_iters': 100,
        'val_freq': 20,
