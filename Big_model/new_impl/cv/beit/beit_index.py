...
from beit import ElasticbeitUtil
...
if __name__ == '__main__':
    ...
    fm_models_dict_path = 'new_impl/cv/beit/results/beit_fbs.py/20231028/999996-170849-/data/zql/concept-drift-in-edge-projects/UniversalElasticNet/new_impl/cv/beit/beit_fbs.py/models/fm_best.pt'
    fm_models_dict_path = save_models_dict_for_init(torch.load(fm_models_dict_path), __file__, 'fm_beit_cls_lora')
    pretrained_md_models_dict_path = 'new_impl/cv/beit/results/beit_fbs.py/20231028/999996-170849-/data/zql/concept-drift-in-edge-projects/UniversalElasticNet/new_impl/cv/beit/beit_fbs.py/models/md_best.pt'
    md_models_dict = torch.load(pretrained_md_models_dict_path)
    md_models_dict_path = save_models_dict_for_init(md_models_dict, __file__, 'md_beit_cls_pretrained_wo_fbs')
