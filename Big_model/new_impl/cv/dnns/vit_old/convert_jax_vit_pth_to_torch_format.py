"""
https://github.com/Sebastian-X/vit-pytorch-with-pretrained-weights
"""
...
if __name__ == '__main__':
    ...
    weight_root_path = os.path.join(os.path.dirname(__file__), './weights')
    ...
    ori_weight_file = 'jx_vit_large_p16_224-4ee7a4dc.pth'
    if backbone:
        trans_weight_file = 'large_p16_224_backbone.pth'
    else:
        trans_weight_file = 'large_p16_224.pth'
    # ----
    
    
    
    weight_txt_root_path = './models'
    if backbone:
    ...
    for key in ori_weight:
        ...
        if div_key[0] == 'norm':
            ...
            trans_key = 'to_patch_embedding.2.' + div_key[-1]
        ...
        if 'to_patch_embedding' in trans_key:
            trans_weight[trans_key] = ori_weight[key].reshape(ori_weight[key].size(0), -1)
        else:
            trans_weight[trans_key] = ori_weight[key]
