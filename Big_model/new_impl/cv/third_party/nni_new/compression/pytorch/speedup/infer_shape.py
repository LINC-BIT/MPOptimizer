...
infer_from_inshape = {
    ...
    'aten::div': lambda module_mask, mask: add_inshape(module_mask, mask),
    'aten::div_': lambda module_mask, mask: add_inshape(module_mask, mask),
    ...
    # implemented by queyu, 2021/06/21,
    'ShuffleBlock': lambda module_masks, mask: relu_inshape(module_masks, mask),
    'hswish': lambda module_masks, mask: relu_inshape(module_masks, mask),
    'hsigmoid': lambda module_masks, mask: relu_inshape(module_masks, mask),
    'Swish': lambda module_masks, mask: relu_inshape(module_masks, mask),
    # implemented by queyu, 2021/07/04
    'LeakyReLU': lambda module_masks, mask: relu_inshape(module_masks, mask),
    'ZeroPad2d': lambda module_masks, mask: maxpool2d_inshape(module_masks, mask),
    # implemented by queyu, 2022/08/05
    'aten::upsample_bilinear2d': lambda module_masks, mask: relu_inshape(module_masks, mask),
    # implemented by queyu, 2022/08/05
    'SiLU': lambda module_masks, mask: relu_inshape(module_masks, mask),
}
...
def convtranspose2d_mask(module_masks, mask):
    ...
    convt_prune_dim = 1
    index, weight_cmask, bias_cmask = convert_to_coarse_mask(mask, dim=convt_prune_dim)
