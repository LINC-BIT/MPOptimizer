...
elasticfm_model = ElasticDNN_ClsOnlineModel('cls', init_online_model(
    ...
    'new_impl/cv/results/cvt_md_index.py/20231019/999999-141144-/data/zql/concept-drift-in-edge-projects/UniversalElasticNet/new_impl/cv/cvt_md_index.py/models/fm_best.pt',
    'new_impl/cv/results/cvt_md_index.py/20231019/999999-141144-/data/zql/concept-drift-in-edge-projects/UniversalElasticNet/new_impl/cv/cvt_md_index.py/models/md_best.pt',
    'cls', __file__
), device, {
    'md_to_fm_alpha': 1,
    'fm_to_md_alpha': 1
