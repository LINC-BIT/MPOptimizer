...
if __name__ == '__main__':
    ...
    fm_models_dict_path = 'new_impl/nlp/mobilebert/sentiment_classification/results/cls_md_wo_fbs.py/20231019/999999-123150/models/fm_best.pt'
    ...
    md_models_dict_path = save_models_dict_for_init(
        torch.load('new_impl/nlp/mobilebert/sentiment_classification/results/cls_md_wo_fbs.py/20231019/999999-123150/models/md_best.pt'), 
    ...
    fm_to_md_alg = ElasticDNN_MDPretrainingIndexAlg(models, get_res_save_dir(__file__, 'result'))
