...
from methods.ewc.ewc_elasticfm import EWCAlg
import tqdm
...
scenario = build_cl_scenario(
    ...
    target_datasets_name=['COCOCls'],
    num_classes_per_task=2,
    max_num_tasks=30,
    data_dirs={
        'GTA5Cls': '/data/zql/datasets/gta5_for_cls_task',
        'SuperviselyPersonCls': '/data/zql/datasets/supervisely_person_for_cls_task',
        'COCOCls': '/data/zql/datasets/coco2017_for_cls_task'
    },
)

from experiments.elasticdnn.vit_b_16.online_new.cls_cl.model import ElasticDNN_ClsOnlineModel
...
da_alg = EWCAlg
from experiments.elasticdnn.vit_b_16.online_new.cls_cl.model import ClsOnlineEWCModel
da_model = ClsOnlineEWCModel
da_alg_hyp = {
    'train_batch_size': 64,
    'val_batch_size': 512,
    'num_workers': 8,
