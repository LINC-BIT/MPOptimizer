...
from methods.gem.gem_el import GEMAlg
import tqdm
...
scenario = build_cl_scenario(
    ...
    target_datasets_name=['COCOCls'] * 4,
...
from experiments.elasticdnn.vit_b_16.online_new.cls_cl.gem2.model import ElasticDNN_ClsOnlineModel
...
da_alg = GEMAlg
from experiments.elasticdnn.vit_b_16.online_new.cls_cl.gem2.model import ClsOnlineGEMModel
da_model = ClsOnlineGEMModel
da_alg_hyp = {
    'train_batch_size': 64,
    'val_batch_size': 512,
    'num_workers': 8,
