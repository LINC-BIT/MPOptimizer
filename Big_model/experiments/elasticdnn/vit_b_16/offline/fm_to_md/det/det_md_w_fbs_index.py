...
if __name__ == '__main__':
    ...
    fm_models_dict_path = 'experiments/elasticdnn/vit_b_16/offline/fm_to_md/det/results/det_md_wo_fbs.py/20230703/999985-130543/models/fm_best.pt'
    ...
    md_models_dict_path = save_models_dict_for_init(
        torch.load('experiments/elasticdnn/vit_b_16/offline/fm_to_md/det/results/det_md_wo_fbs.py/20230703/999985-130543/models/md_best.pt'), 
        __file__, 'md_vit_b_16_det_raw_pretrained')
    device = 'cuda'
