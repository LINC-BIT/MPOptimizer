...
if __name__ == '__main__':
    ...
    fm_models_dict_path = 'experiments/elasticdnn/vit_b_16/offline/fm_to_md/seg/results/seg_md_wo_fbs.py/20230611/999998-141814/models/fm_best.pt'
    fm_models_dict_path = save_models_dict_for_init(torch.load(fm_models_dict_path), __file__, 'fm_vit_b_16_seg_lora')
    ...
    md_models_dict_path = save_models_dict_for_init(torch.load(pretrained_md_models_dict_path), __file__, 'md_vit_b_16_seg_pretrained_wo_fbs')
    device = 'cuda'
    ...
    fm_to_md_alg = ElasticDNN_MDPretrainingWFBSAlg(models, get_res_save_dir(__file__, sys.argv[1]))
