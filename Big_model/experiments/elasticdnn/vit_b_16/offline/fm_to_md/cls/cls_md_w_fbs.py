...
if __name__ == '__main__':
    ...
    fm_models_dict_path = 'experiments/elasticdnn/vit_b_16/offline/fm_to_md/cls/results/cls_md_wo_fbs.py/20230611/999998-142441-new_md_structure/models/fm_best.pt'
    fm_models_dict_path = save_models_dict_for_init(torch.load(fm_models_dict_path), __file__, 'fm_vit_b_16_cls_lora')
    pretrained_md_models_dict_path = 'experiments/elasticdnn/vit_b_16/offline/fm_to_md/cls/results/cls_md_wo_fbs.py/20230611/999998-142441-new_md_structure/models/md_best.pt'
