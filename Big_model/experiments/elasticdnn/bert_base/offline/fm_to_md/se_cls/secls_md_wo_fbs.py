...
if __name__ == '__main__':
    ...
    # 1. init model
    fm_models_dict_path = 'experiments/elasticdnn/bert_base/offline/fm_lora/se_cls/results/se_cls.py/20230628/star_multilinguial_ok_999981-190501-multi_lin_bert_trial/models/fm_best.pt'
