...
if __name__ == '__main__':
    ...
    # 1. init model
    fm_models_dict_path = 'experiments/elasticdnn/bert_base/offline/fm_lora/pos/results/pos.py/20230630/999989-113655-trial/models/fm_best.pt'
    fm_models = torch.load(fm_models_dict_path)
    fm_models_dict_path = save_models_dict_for_init(fm_models, __file__, 'fm_bert_base_tokencls_lora')
    md_models_dict_path = save_models_dict_for_init({
        'main': -1
    }, __file__, 'md_bert_base_none')
    device = 'cuda'
