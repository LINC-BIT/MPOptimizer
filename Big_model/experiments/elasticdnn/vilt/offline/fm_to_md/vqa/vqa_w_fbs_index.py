...
class ElasticDNN_Vilt_OfflineVQAFMModel(ElasticDNN_OfflineVQAFMModel):
    ...
    def get_feature_hook(self) -> LayerActivation2:
        return LayerActivation2(get_module(self.models_dict['main'], 'classifier.3'))
    
    def get_elastic_dnn_util(self) -> ElasticDNNUtil: # TODO:
        return ElasticViltUtil()
...
if __name__ == '__main__':
    ...
    fm_models_dict_path = 'experiments/elasticdnn/vilt/offline/fm_to_md/vqa/results/vqa_wo_fbs.py/20230730/999994-204649-trial/models/fm_best.pt'
    ...
    md_models_dict_path = save_models_dict_for_init(
        torch.load('experiments/elasticdnn/vilt/offline/fm_to_md/vqa/results/vqa_wo_fbs.py/20230730/999994-204649-trial/models/md_best.pt'), 
        __file__, 'md_vilt_vqa_raw_pretrained')
    device = 'cuda'
