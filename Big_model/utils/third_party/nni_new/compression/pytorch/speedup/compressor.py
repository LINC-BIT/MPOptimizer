...
import logging
import torch
from ....compression.pytorch.utils.mask_conflict import fix_mask_conflict
from ....compression.pytorch.utils.utils import get_module_by_name
...
class ModelSpeedup:
    ...
    def __init__(self, model, dummy_input, masks_file, map_location=None):
        ...
        """
        from ....common.graph_utils import build_module_graph
    ...
    def speedup_model(self):
        ...
        fixed_masks, conv_prune_dim = fix_mask_conflict(self.masks, self.bound_model, self.dummy_input)
