...
class MobileViT(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        x = self.conv_1(x)
        # x = checkpoint(self.layer_1,x)
        # x = checkpoint(self.layer_2,x)

        # x = checkpoint(self.layer_3,x)
        # x = checkpoint(self.layer_4,x)
        # x = checkpoint(self.layer_5,x)
        # x = checkpoint(self.conv_1x1_exp,x)
        # x = checkpoint(self.classifier,x)
